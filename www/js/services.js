angular.module('Banking.services', ['Banking.filters'])
...
.factory('Cards', function(Card) {
    ...
    var cards = [
        new Card({
            id: 1, ownerID: 0, timestamp: "2014-03-29T23:03:20-02:00", name: 'GoldCard',
            number: '4000200010004000', balance: "23045.23", currency: 'eur', type: 'debit'
        }),
        new Card({
            id: 0, ownerID: 0, timestamp: "2013-02-29T23:03:20-02:00", name: 'Deposit card',
            number: '5212232874504340', balance: "1089.23", currency: 'usd', type: 'debit'
        }),
        new Card({
            id: 2, ownerID: 0, timestamp: "2012-02-10T23:03:20-02:00", name: 'Credit card',
            number: '5234264874504340', balance: "1089.23", currency: 'usd', type: 'credit'
        })
    ];
